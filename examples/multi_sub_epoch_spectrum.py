...
from Baking_EEG import _4_epoch_spectrum as epo_psd
...
print("################## Spectrum computation " + str(sujets) + " ##################")

epo_psd.epo_spectrum_overSubs(sujets, selected_chans, protocol, cfg, save=save, plot=plot, show_plot=plot)

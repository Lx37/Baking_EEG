...
# 'data_epochs/' # Patch for Vera - should be updated #TODO
data_epochs_path = data_con_path
...
all_folders_LG = {key: value.replace('PP', 'LG')
                  for key, value in all_folders_PP.items()}
all_folders_Resting = {key: value.replace(
    'PP', 'Resting') for key, value in all_folders_PP.items()}
...
EGI_misc_dict = {'E8': 'misc', 'E25': 'misc',
                 'E17': 'misc', 'E126': 'misc', 'E127': 'misc'}
EGI_misc_dict_BRU = {'E125': 'misc', 'E126': 'misc', 'E127': 'misc',
                     'E128': 'misc', 'E119': 'misc', 'E48': 'misc', 'ECG': 'misc'}

# VEOG = veog1 - veog
occular_EGI = {'veog1': 'E25', 'veog2': 'E127', 'veogr1': 'E8',
               'veogr2': 'E126', 'heog1': 'E32', 'heog2': 'E1'}
...
eog_threshold = 3
# For ICA
# 15 was ok #0.99 from Fabrice  # (instead of 0.95) if float, select n_components by explained variance of PCA
n_components = 0.95
...
con_event_ids_BRU = ['Music', 'Noise', 'Rest after Music',
                     'Rest after noise', 'Interact music', 'Interact noise']
con_event_ids = ['303']

con_all_ROI_chan = {
    # E17, E21, E14
    'ROI_Frontal': ['E22', 'E15', 'E9', 'E18', 'E16', 'E10', 'E19', 'E11', 'E4', 'E12', 'E5'],
    # 121 E8, E1
    'ROI_Frontal_droit': ['E2', 'E3', 'E123', 'E124', 'E122', 'E118', 'E117', 'E116'],
    # E38
    'ROI_Frontal_gauche': ['E26', 'E23', 'E27', 'E24', 'E33', 'E34', 'E28', 'E20'],
    # Remis CZ (nommé 'VREF', position 128) E128
    'ROI_Central':  ['E6', 'E13', 'E112', 'E30', 'E7', 'E106', 'E105', 'E31', 'E37', 'E80', 'E87', 'E79', 'E54', 'E55'],
    # E114
    'ROI_Temporal_droit': ['E110', 'E111', 'E115', 'E109', 'E104', 'E103', 'E108', 'E93', 'E98', 'E102'],
    # E44
    'ROI_Temporal_gauche':  ['E39', 'E35', 'E29', 'E40', 'E41', 'E36', 'E45', 'E46', 'E47', 'E42'],
    # E74, E82
    'ROI_Parietal': ['E61', 'E62', 'E78', 'E67', 'E72', 'E77', 'E71', 'E76', 'E70', 'E75', 'E83'],
    # E57, E64, E69
    'ROI_Occipito_temporal_droit': ['E50', 'E51', 'E52', 'E53', 'E58', 'E59', 'E60', 'E65', 'E66'],
    # E100, E95, E89
    'ROI_Occipito_temporal_gauche': ['E86', 'E92', 'E97', 'E101', 'E85', 'E91', 'E96', 'E84', 'E90']
}
...
EGI_con_chan = [x for x in EGI_chan_names if x not in EGI_misc_dict.keys()]
# All chan - those declared as misc
EGI_con_chan_BRU = [
...
#TYS6 : 401 point temporels pour LG
#TpJC5 : 301 points temporels pour PP
ALL_SUBJECTS_GROUPS = {
    "COMA": [
        "TF53", "CA55", "JA61", "ME64", "MP68", "SV62", 
        "TpAT19J1", "TpCF24J1", "TpEM13J1", "TpEP16J1", "TT45", "YG72",
        "CS38", "JC39", "TpCL14j1", "TpMG17J1", "TpMB18J1", "TpEP20J1", 
        "TpLC21J1", "TpDC22J1", "TpPC23J1", "MV48", "TpFM25J1", "TpCD26J1", 
        "ME63", "NN65", "SB67", "MB73", "KS76", "GV77", "JM78", "JR79", 
        "BS81", "FB83", "AP84"
    ],
    ...
    "MCS": [
        ...
        "TpCF24J8", "SR59", "MK80", "PL82", "AM88", "XL89", "OS90", 
        "PM95", "MG96", "LC97", "PF100"
    ],
    
    "DELIRIUM+": [
        "TpAK24", "TpAK27", "TpCB15", "TpDRL3", "TpJB25", "TpJLR17", 
        "TpMB45", "TpMN42", "TpPC21", "TpPM14", "TpRD38",
        "TpCF1", "TpMM4", "TpJC5", "TpJB26", "TpLA28", "TpPM31", 
        "TpSM49", "TpJPS55", "TpFY57"
    ],
    
    "DELIRIUM-": [
        "TpJPG7", "TpAM43", "TpJPL10", "TpLP11", "TpMD13", "TpBD16", 
        "TpFL53", "TpME22", "TpAC23", "TpSD30", "TpKS6", "TpPA35",
        "TpCG36", "TpRK39", "TpYB41", "TpGB8", "TpPI46", "TpBL47", 
